							...
							<div class="aside-user-info flex-row-fluid flex-wrap ms-5">
								...
								<div class="d-flex">
									...
									<div class="flex-grow-1 me-2">
										<!--begin::Username-->
										<a href="#" class="text-white text-hover-primary fs-6 fw-bold">{{ \Auth::user()->fullname }}</a>
										<!--end::Username-->
										<!--begin::Description-->
										<span class="text-gray-600 fw-semibold d-block fs-8 mb-1">{{ \Auth::user()->position }}</span>
										<!--end::Description-->
										<!--begin::Label-->
									...
									<div class="me-n2">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
											...
											<div class="menu-item px-5">
												<a href="{{ route('vendor.logout') }}" class="menu-link px-5">Sign Out</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu separator-->
											{{-- <div class="separator my-2"></div> --}}
