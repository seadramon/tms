    ...
    <div class="card-body">    
        ...
        <div class="form-group row">
            <div class="col-lg-6 custom-form">
                ...
                {!! Form::select('vendor_id', $vendor, $vendor_id, ['class'=>'form-control form-select-solid', 'data-control'=>'select2', 'id'=>'vendor_id'] + $disabled) !!}
            </div>

            <div class="col-lg-6 custom-form">
                <label class="form-label col-sm-3 custom-label">Pekerjaan</label>
                {!! Form::select('kd_jpekerjaan', $jenisPekerjaan, $jenis_angkutan ?? null, ['class'=>'form-control form-select-solid', 'data-control'=>'select2', 'id'=>'kd_jpekerjaan'] + $disabled) !!}
            </div>
        </div>
        <div class="form-group row">
            <div class="col-lg-6 custom-form">
                <label class="form-label col-sm-3 custom-label">Satuan HarSat</label>
                {!! Form::select('sat_harsat', $sat_harsat, $data->satuan_harsat ?? null, ['class'=>'form-control form-select-solid', 'data-control'=>'select2', 'id'=>'sat_harsat'] + $disabled) !!}
            </div>
        </div>
    </div>
