            ...
            <div class="card shadow-sm">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{route('spk.create')}}" class="btn btn-light-primary me-2" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Tambah SPK</a>
                ...
                <div class="card-body py-0">
                    <table id="tabel_spk" class="table table-row-bordered gy-5" style="vertical-align: middle;">
                        <thead>
	...
	var KTDatatablesServerSide = function () {
	    ...
	    var initDatatable = function () {
	        dt = $("#tabel_spk").DataTable({
	            ...
	            columns: [
	                {data: 'no_spk', name: 'no_spk', defaultContent: '-'},
	                {data: 'no_npp', name: 'no_npp', defaultContent: '-'},
	                {data: 'tgl_spk', name: 'tgl_spk', defaultContent: '-'},
