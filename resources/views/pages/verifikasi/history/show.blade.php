                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mb-3 col-lg-3">
                            ...
                            {!! Form::select('v_stnk', $verify, $data->v_stnk, ['class'=>'form-control form-select-solid', 'data-control'=>'select2', 'disabled' => 'disabled', 'id'=>'v_stnk']) !!}
                        </div>
                        ...
                        <div class="form-group mb-3 col-lg-3">
                            <label class="form-label required">Verifikasi</label>
                            {!! Form::select('v_kir_head', $verify, $data->v_kir_head, ['class'=>'form-control form-select-solid', 'data-control'=>'select2', 'disabled' => 'disabled', 'id'=>'v_kir_head']) !!}
                        </div>
                        ...
                        <div class="form-group mb-3 col-lg-3">
                            <label class="form-label required">Verifikasi</label>
                            {!! Form::select('v_kir_trailer', $verify, $data->v_kir_trailer, ['class'=>'form-control form-select-solid', 'data-control'=>'select2', 'disabled' => 'disabled', 'id'=>'v_kir_trailer']) !!}
                        </div>
                        ...
                        <div class="form-group mb-3 col-lg-3">
                            <label class="form-label required">Verifikasi</label>
                            {!! Form::select('v_pajak', $verify, $data->v_pajak, ['class'=>'form-control form-select-solid', 'data-control'=>'select2', 'disabled' => 'disabled', 'id'=>'v_pajak']) !!}
                        </div>

                        <div class="form-group mb-3 mt-5 col-lg-4">
                            <label class="form-label required">Visual</label>
                            {!! Form::select('visual', $verify, $data->visual, ['class'=>'form-control form-select-solid', 'data-control'=>'select2', 'disabled' => 'disabled', 'id'=>'visual']) !!}
                        </div>
                        <div class="form-group mb-3 mt-5 col-lg-4">
                            <label class="form-label required">Kelengkapan Armada</label>
                            {!! Form::select('kelengkapan', $verify, $data->kelengkapan, ['class'=>'form-control form-select-solid', 'data-control'=>'select2', 'disabled' => 'disabled', 'id'=>'kelengkapan']) !!}
                        </div>
                        <div class="form-group mb-3 mt-5 col-lg-4">
                            <label class="form-label required">Kondisi Ban</label>
                            {!! Form::select('kondisi_ban', $verify, $data->kondisi_ban, ['class'=>'form-control form-select-solid', 'data-control'=>'select2', 'disabled' => 'disabled', 'id'=>'kondisi_ban']) !!}
                        </div>
                    </div>
                </div>
            
                <div class="card-footer" style="text-align: right;">
                <a href="{{ route('history-armada.index') }}" class="btn btn-light btn-active-light-primary me-2">Kembali</a>
                </div>
            </div>
        </div>
        <!--end::Col-->
