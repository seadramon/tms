...
<div class="page-title d-flex justify-content-center flex-column me-5">
    <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">History Verifikasi Armada</h1>
</div>
<!--end::Page title-->
@endsection
@section('content')
        ...
        <div class="col-12 mb-md-5 mb-xl-10">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h3 class="card-title">History Verifikasi Armada</h3>
                </div>
	...
	var KTDatatablesServerSide = function () {
	    ...
	    var initDatatable = function () {
	        dt = $("#tabel_master_armada").DataTable({
	            ...
	            order: [[1, 'desc']],
	            stateSave: true,
	            ajax: "{{ route('history-armada.data') }}",
	            columns: [
